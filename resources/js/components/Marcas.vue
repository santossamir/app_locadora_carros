    ...
    <div class="container">
        ...
        <modal-component id="modalMarcaAtualizar" titulo="Atualizar marca">
            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group mt-3">
                    <input-container-component titulo="Imagem" id="atualizarImagem" id-help="atualizarImagemHelp" texto-ajuda="Selecione imagem no formato PNG">
        ...
        <!-- Final do modal para atualizar marcas -->
    </div>
</template>
